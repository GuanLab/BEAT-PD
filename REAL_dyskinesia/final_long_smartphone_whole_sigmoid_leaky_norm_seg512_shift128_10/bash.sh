...
python map_id.py
python split_test.py ../../../testdata_new/real-testing_data/smartphone_accelerometer_split_512_shift_128/
python split_train.py ../../../rawdata_new/real-pd.training_dat/smartphone_accelerometer_split_512_shift_128/
